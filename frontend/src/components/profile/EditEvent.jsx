  ...
  if (isLoading) {
    return (
      <div className="flex h-64 items-center justify-center">
        <div className="text-lg font-medium">Loading event data...</div>
      </div>
    );
  }
  ...
  return (
    <div className="overflow-hidden rounded-md">
      <div className="bg-white px-16 py-8 pb-16">
        <h1 className="mb-6 text-4xl font-bold">Edit Event</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              {!imagePreview
                ...
                : "You can upload a new image or keep the current one"}
            </p>
          </div>
          ...
          <div className="flex space-x-4">
            <button
              ...
              className="cursor-pointer rounded-lg border bg-white px-4 py-2 text-black uppercase transition-all duration-300 hover:border-black hover:bg-white hover:text-black active:scale-95"
            >
              Cancel
            </button>
            <button
